...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="https://source.unsplash.com/random/1620x400/?coding,python" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
    <!-- <img src="/img/slid3.jfif" class="d-block w-100" alt="..."> -->
      <img src="https://source.unsplash.com/random/1620x400/?coding,java" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
    <!-- <img src="/img/slid3.jfif" class="d-block w-100" alt="..."> -->
      <img src="https://source.unsplash.com/random/1620x400/?coding,AI" class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <img src="https://source.unsplash.com/random/200x100/?codeing, ' .$cat.',coding" class="card-img-top" alt="pythonimg">
      <div class="card-body">
